...
export const defaultThemes = [
    ...
    },
    {
        ...
        themeColors: includeAllProperties({
            primaryContrastA: "#461220",
            primaryContrastB: "#FED0BB",
            secondaryContrastA: "#8C2F39",
            secondaryContrastB: "#FCB9B2",
            neutral: "#B23A48",
            highlight: "#ff477e",
        }),
    },
    {
        name: "Default Theme 8",
        themeColors: includeAllProperties({
            primaryContrastA: "#B9375E",
            primaryContrastB: "#FAE0E4",
            secondaryContrastA: "#E05780",
            secondaryContrastB: "#FFE0E9",
            neutral: "#FF7AA2",
            highlight: "#FF9EBB",
        })
    },
